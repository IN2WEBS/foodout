...
router.post('/api/login', (req, res) => {
    ...
    // darom uzklausa i db surandam vartotoja ir tikrinam pass
    if (req.body.name === name && req.body.password === password) {
        const token = jwt.sign({name: 'admin', shop: 'mcdonalds'}, 'keyboard cat', {expiresIn:'2h'});
